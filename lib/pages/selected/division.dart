...
class SelectedDivision extends StatefulWidget with PageState {
  const SelectedDivision({
    Key? key,
  }) : super(key: key);

  @override
  State<SelectedDivision> createState() => _SelectedDivisionState();
}

class _SelectedDivisionState extends State<SelectedDivision>
