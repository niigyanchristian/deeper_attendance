...
class Input extends StatefulWidget {
  ...
  const Input({Key? key, required this.today}) : super(key: key);
...
class _InputState extends State<Input> with SingleTickerProviderStateMixin {
  ...
  void init() {
    ...
    sermon = ["", ""];
    remarks = "";
    month = DateFormat("MMMM").format(widget.today);
    year = DateFormat("y").format(widget.today);
  }
                        ...
                        onTap: () {
                          if (sermon[0] != "" && sermon[1] != "") {
                            ...
                            cloud
                              ...
                              service: fxn.eventCol(today),
                              today: today,
                              isNotYear: cloudCtx.years
                                  .where((ele) => ele.year == year)
                                  .isEmpty,
                            )
                                .then((value) {
