...
class DivisionUser extends StatefulWidget {
  final List<Admin>? admin;

  const DivisionUser({Key? key, this.admin}) : super(key: key);
  @override
  _DivisionUserState createState() => _DivisionUserState();
}

class _DivisionUserState extends State<DivisionUser> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    List<DivisionModel> divisions = Provider.of<List<DivisionModel>>(context);
                          ...
                          Padding(
                            ...
                            child: RichText(
                              ...
                              text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text: "Available divisions for this region",
                                  ),
                                ],
                              ),
                            ),
                        ...
                        child: PageView(
                          ...
                          children: [
                            for (int i = 0; i < divisions.length; i++)
                              division(divisions[i].name, divisions[i].documentID, divisions[i].regionID, i,
  ...
  Widget division(String? division, String? divisionID, String? regionID, int current, double screenWidth,
  ...
  void process(
    ...
    /*await AuthService().registerAdmins(
        ...
        selectedPosition,
        selectedDivisionID,
        selectedDivision, [selectedRegionID, ""]).then((value) {
