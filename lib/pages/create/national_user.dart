...
class NationalUser extends StatefulWidget {
  ...
  @override
  State<NationalUser> createState() => _NationalUserState();
}
...
class _NationalUserState extends State<NationalUser>
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onFieldSubmitted: (value) {
                                      if (value != "") {
                                        process(name.text, position.text,
                                            email.text, value);
                                      } else {
                                        if (!error) {
                                          _errorTimer();
                      ...
                      GestureDetector(
                        onTap: () {
                          if (password.text != "" &&
                            ...
                            process(name.text, position.text, email.text,
                                password.text);
                          } else {
                            if (!error) {
                              _errorTimer();
  ...
  process(String nameValue, String positionValue, String emailValue,
