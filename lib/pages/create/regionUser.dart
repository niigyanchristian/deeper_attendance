...
class RegionUser extends StatefulWidget {
  ...
  @override
  _RegionUserState createState() => _RegionUserState();
}

class _RegionUserState extends State<RegionUser>
  ...
  Widget region(String? region, String? regionID, int current, double screenWidth,
