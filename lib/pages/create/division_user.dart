...
class DivisionUser extends StatefulWidget {
  ...
  @override
  State<DivisionUser> createState() => _DivisionUserState();
}

class _DivisionUserState extends State<DivisionUser>
                        ...
                        child: PageView(
                          ...
                          children: [
                            for (int i = 0; i < divisions.length; i++)
                              division(
                                  divisions[i].name,
                                  divisions[i].documentID,
                                  divisions[i].regionID,
                                  i,
                                  screenWidth,
                                  textStyling),
                          ],
  ...
  Widget division(String? division, String? divisionID, String? regionID,
      int current, double screenWidth, TextStyling textStyling) {
