...
class _CreateGroupState extends State<CreateGroup> with TickerProviderStateMixin {
                  ...
                  child: Column(
                    children: [
                      ...
                      StreamProvider<List<GroupModel>>.value(
                        value: Cloud().groups,
                        initialData: [],
                        child: AllGroups(pageController: pageController, admin: widget.admin,),
                      ),
                      SizedBox(height: 20),
                    ],
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            onFieldSubmitted: (value) {
                              if (value != "") {
                                process(value, widget.admin!.first.profile, widget.admin!.first.others![0], widget.admin!.first.areaID);
                              } else {
                                setState(() {
                                  error = true;
                                  errorMessage = "Field cannot be empty on submission";
                                });
                                _errorTimer();
                              }
                            },
                        ...
                        GestureDetector(
                          onTap: () {
                            if (selectedGroup != "") {
                              process(selectedGroup, widget.admin!.first.profile, widget.admin!.first.others![0], widget.admin!.first.areaID);
                            } else {
                              setState(() {
                                error = true;
                                errorMessage = "Field cannot be empty on submission";
                            ...
                            child: Center(
                              child: loading
                                ...
                                child: CircularProgressIndicator(
                                  ...
                                  : Text("Insert", style: textStyling.boldWhite16,),
                            ),
                          ),
                        ),
                      ],
  ...
  process(String value, String? creator, String regionID, String? divisionID) async {
...
class AllGroups extends StatefulWidget {
  ...
  const AllGroups({Key? key, this.pageController, this.admin}) : super(key: key);
  @override
...
class _AllGroupsState extends State<AllGroups> {
      ...
      child: PageView(
        ...
        children: [
          for (int i = 0; i < groups.length; i++)
            group(groups[i].name, i, screenWidth,
                textStyling),
        ],
      ),
    );
  ...
  Widget group(String? group, int current, double screenWidth,
