...
class LocalUserReview extends StatefulWidget {
  final List<Admin>? admin;

  const LocalUserReview({Key? key, this.admin}) : super(key: key);
  @override
  _LocalUserReviewState createState() => _LocalUserReviewState();
}

class _LocalUserReviewState extends State<LocalUserReview> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    List<LocalModel> locals = localsModel.where((element) => element.groupID == widget.admin!.first.areaID).toList();
